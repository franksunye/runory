...
- [External Benchmark Adoption Guardrails](product/external-benchmark-adoption-guardrails.md) — mandatory anti-fragmentation and complexity controls for benchmark-driven changes.
