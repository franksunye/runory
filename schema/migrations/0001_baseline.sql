...
-- Description: Initial platform schema (organizations, users, memberships, workspaces, metadata, extensions, audit)
-- Idempotent: Uses IF NOT EXISTS so it is safe to run on databases previously initialized by ensureSchema().
