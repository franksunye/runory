...
export const COMMAND_IMPLEMENTATIONS: readonly CommandImplementationDeclaration[] = [
  ...
  { key: "quote.add_line", aggregate: "quote", sourceFile: "quote-commands.ts" },
  { key: "quote.update_line", aggregate: "quote", sourceFile: "quote-commands.ts" },
  { key: "quote.remove_line", aggregate: "quote", sourceFile: "quote-commands.ts" },
  { key: "quote.restore_line", aggregate: "quote", sourceFile: "quote-commands.ts" },
