    ...
    <footer className="border-t border-black/10 bg-[#fbf8f1]">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            {recommendations.map(([title, href, body]) => (
              <Link key={href} href={href} className="group flex min-h-[156px] flex-col justify-between rounded-2xl border border-black/10 bg-[#fbf8f1] p-6 transition hover:-translate-y-0.5 hover:border-orange-300 hover:shadow-sm sm:p-7">
      ...
      <div className="border-b border-black/10 bg-neutral-950 text-white">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-7 px-5 py-12 sm:px-6 md:flex-row md:items-center lg:px-10">
          ...
          <Link href="/pilot" className="inline-flex min-h-12 shrink-0 items-center gap-2 rounded-full bg-orange-600 px-7 font-semibold text-white">{c.pilotCta} <ArrowRight size={18} /></Link>
        </div>
      </div>
