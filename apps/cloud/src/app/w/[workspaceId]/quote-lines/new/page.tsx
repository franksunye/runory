...
const VIEW_KEY = "quote_line_form";

export default function NewQuoteLinePage() {
  ...
  const handleSubmit = async (data: Record<string, any>) => {
    ...
    try {
      ...
      if (json.success) {
        router.push(`/w/${workspaceId}/quote-lines`);
        router.refresh();
      } else {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">新建报价项</h1>
