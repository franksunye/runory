...
const OBJECT_KEY = "work_order";
const VIEW_KEY = "work_order_list";
const PAGE_SIZE = 20;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">管理所有工单记录</p>
        </div>
        {hasPack && (
          <button
            type="button"
            onClick={() =>
              router.push(`/w/${workspaceId}/work-orders/new`)
            }
          ...
          {totalCount === 0 ? (
            isSearching ? (
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-8 text-center">
                ...
                <button
                  type="button"
                  onClick={() => router.push(`/w/${workspaceId}/work-orders/new`)}
