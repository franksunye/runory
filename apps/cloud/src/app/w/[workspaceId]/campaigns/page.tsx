...
const OBJECT_KEY = "campaign";
const VIEW_KEY = "campaign_list";
const PAGE_SIZE = 20;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">管理所有营销活动记录</p>
        </div>
        {hasPack && (
          <button
            type="button"
            onClick={() =>
              router.push(`/w/${workspaceId}/campaigns/new`)
            }
      ...
      {!hasPack ? (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-8 text-center">
          ...
          <p className="mt-1 text-sm text-blue-700">安装 CRM Lite Pack 后即可开始管理营销活动。</p>
          <Link
        ...
        <div className="space-y-3">
          ...
          {totalCount === 0 ? (
            isSearching ? (
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-8 text-center">
                <p className="text-sm text-slate-500">还没有营销活动记录</p>
                <button
                  type="button"
                  onClick={() => router.push(`/w/${workspaceId}/campaigns/new`)}
            ...
            <>
              <SchemaTable
                ...
                basePath={`/w/${workspaceId}/campaigns`}
              />
              {hasMore && (
