...
const OBJECT_KEY = "conversation";
const VIEW_KEY = "conversation_list";
const PAGE_SIZE = 20;
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">管理工单对话和评论</p>
        </div>
        {hasPack && (
          <button
            type="button"
            onClick={() =>
              router.push(`/w/${workspaceId}/conversations/new`)
            }
      ...
      {!hasPack ? (
        <div className="rounded-lg border border-blue-200 bg-blue-50 p-8 text-center">
          ...
          <p className="mt-1 text-sm text-blue-700">安装 CRM Lite Pack 后即可开始管理对话。</p>
          <Link
          ...
          {totalCount === 0 ? (
            isSearching ? (
              ...
              <div className="rounded-lg border border-slate-200 bg-white p-8 text-center">
                ...
                <button
                  type="button"
                  onClick={() => router.push(`/w/${workspaceId}/conversations/new`)}
            ...
            <>
              <SchemaTable
                ...
                basePath={`/w/${workspaceId}/conversations`}
              />
              {hasMore && (
