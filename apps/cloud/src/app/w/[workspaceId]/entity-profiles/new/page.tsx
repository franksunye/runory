...
const VIEW_KEY = "entity_profile_form";

export default function NewEntityProfilePage() {
  ...
  const handleSubmit = async (data: Record<string, any>) => {
    ...
    try {
      ...
      if (json.success) {
        router.push(`/w/${workspaceId}/entity-profiles`);
        router.refresh();
      } else {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">新建实体画像</h1>
