...
const VIEW_KEY = "service_visit_form";

export default function NewServiceVisitPage() {
  ...
  const handleSubmit = async (data: Record<string, any>) => {
    ...
    try {
      ...
      if (json.success) {
        router.push(`/w/${workspaceId}/service-visits`);
        router.refresh();
      } else {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-900">新建服务行程</h1>
