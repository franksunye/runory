        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[.82fr_1.18fr] lg:items-center lg:px-10">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href="/voice" className="inline-flex min-h-12 items-center gap-2 rounded-full bg-white px-6 font-semibold text-neutral-950">{zh ? "查看语音接单架构" : "Explore Voice Intake"}<ArrowRight size={18} /></Link>
