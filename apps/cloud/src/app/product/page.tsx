...
export default function ProductPage() {
  ...
  return <main className="min-h-screen bg-[#fbf8f1] text-neutral-950">
    ...
    <section className="mx-auto max-w-7xl px-5 py-16 sm:px-6 sm:py-24 lg:px-10">
      ...
      <div className="mt-10 flex flex-wrap gap-3"><Link href="/pilot" className="inline-flex items-center gap-2 rounded-full bg-neutral-950 px-6 py-3 font-semibold text-white">{c.cta} <ArrowRight size={18}/></Link><Link href="/platform" className="inline-flex rounded-full border border-black/15 bg-white px-6 py-3 font-semibold">{zh ? "了解平台架构" : "Explore the Platform"}</Link></div>
    </section>
