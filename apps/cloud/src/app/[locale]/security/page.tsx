    ...
    <main className="min-h-screen bg-[#fbf8f1] text-neutral-950">
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <LocaleLink href="/login" className="inline-flex items-center gap-2 rounded-full bg-neutral-950 px-6 py-3 font-semibold text-white"><ShieldCheck size={18} /> {t("security.cta")} <ArrowRight size={16} /></LocaleLink>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20 lg:px-10">
        <div className="flex flex-wrap items-center gap-4">
          <LocaleLink href="/pricing" className="inline-flex items-center gap-2 rounded-full border border-black/15 bg-white px-5 py-2.5 text-sm font-semibold"><ScrollText size={17} /> {t("common.pricing")}</LocaleLink>
          <LocaleLink href="/open-source" className="inline-flex items-center gap-2 rounded-full border border-black/15 bg-white px-5 py-2.5 text-sm font-semibold"><BookOpen size={17} /> {t("common.openSource")}</LocaleLink>
