  ...
  return (
    <main className="min-h-screen bg-[#fbf8f1] text-neutral-950">
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-10">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            {copy.industries.map((item, index) => {
              ...
              return item.href ? (
                <LocaleLink key={item.title} href={item.href} className="group rounded-[24px] border border-black/10 bg-[#fbf8f1] p-6 transition hover:-translate-y-1 hover:border-orange-300 hover:shadow-[0_24px_60px_rgba(50,35,20,.10)] sm:p-7">
                  {content}
                </LocaleLink>
              ) : (
      ...
      <section className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-5 py-16 sm:px-6 sm:py-20 md:flex-row md:items-center lg:px-10">
        ...
        <LocaleLink href="/pilot" className="inline-flex shrink-0 items-center gap-2 rounded-full bg-neutral-950 px-6 py-3 font-semibold text-white">
