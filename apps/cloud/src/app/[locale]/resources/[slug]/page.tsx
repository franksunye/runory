...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const article = articles[normalizedLocale][slug as Slug];
      ...
      <article>
        ...
        <section className="mx-auto max-w-4xl px-5 py-16 sm:py-20">
          <div className="rounded-[24px] bg-neutral-950 p-7 text-white sm:p-10">
            <p className="text-sm font-semibold uppercase tracking-[.16em] text-orange-300">{normalizedLocale === "zh" ? "关键结论" : "Practical takeaways"}</p>
